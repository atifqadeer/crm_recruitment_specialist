  ...
  $(document).on('submit', '[id^="editSaleNoteForm"]', function (e) {
    ...
    switch (datatableName) {
        case 'close_sale_nurse_sample':
            ajaxUrl = '/closed-sales-nurse'; // Define your actual route here
            break;
        case 'close_sale_nonnurse_sample':
            ajaxUrl = '/closed-sales-nonnurse'; // Define your actual route here
            break;
        case 'close_sale_specialist_sample':
            ajaxUrl = '/closed-sales-specialist'; // Define your actual route here
            break;
        default:
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            switch (datatableName) {
                case 'close_sale_nurse_sample':
                    close_sales_tab("close_sale_nurse_sample", "closed-sales-nurse", columns);
                    break;
                case 'close_sale_nonnurse_sample':
                    close_sales_tab("close_sale_nonnurse_sample", "closed-sales-nonnurse", columns);
                    break;
                case 'close_sale_specialist_sample':
                    close_sales_tab("close_sale_specialist_sample", "closed-sales-specialist", columns);
                    break;
                default:
