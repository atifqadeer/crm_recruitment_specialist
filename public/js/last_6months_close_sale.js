...
var route = "last-6months-closed-sales-nurse-ajax";
  ...
  $(document).on("shown.bs.tab", ".nav-tabs a", function(event) {
    ...
    switch (tab_href) {
      case "close_sale_nurse":
        ...
        route = "last-6months-closed-sales-nurse-ajax";
        columns = [
          { data: "created_at", name: "sales.created_at" },
        //   { data: "updated_at", name: "sales.updated_at" },
          {
      ...
      case "close_sale_nonnurse":
        ...
        route = "last-6months-closed-sales-nonnurse-ajax";
        columns = [
          { data: "created_at", name: "sales.created_at" },
        //   { data: "updated_at", name: "sales.updated_at" },
          {
      ...
      case "close_sale_specialist":
        ...
        route = "last-6months-closed-sales-specialist-ajax";
        columns = [
          { data: "created_at", name: "sales.created_at" },
        //   { data: "updated_at", name: "sales.updated_at" },
          {
...
$(document).ready(function() {
  ...
  function initializeDataTables() {
    filter_close_sales_tab(
      ...
      "last-6months-closed-sales-nurse-ajax",
      getColumns(),
      $("#office_id_nurse").val()
    );
    filter_close_sales_tab(
      "close_sale_nonnurse_sample",
      "last-6months-closed-sales-nonnurse-ajax",
      getColumns(),
      $("#office_id_nonnurse").val()
    );
    filter_close_sales_tab(
      "close_sale_specialist_sample",
      "last-6months-closed-sales-specialist-ajax",
      getColumns(),
  ...
  $(document).on("change", ".office_id", function() {
    ...
    switch (form_id) {
      case "close_sale_nurse_form":
        filter_close_sales_tab(
          "close_sale_nurse_sample",
          "last-6months-filter-closed-sales-nurse",
          getColumns(),
          office_id
        );
        break;
      case "close_sale_nonnurse_form":
        filter_close_sales_tab(
          "close_sale_nonnurse_sample",
          "last-6months-filter-closed-sales-nonnurse",
          getColumns(),
          office_id
        );
        break;
      case "close_sale_specialist_form":
        filter_close_sales_tab(
          "close_sale_specialist_sample",
          "last-6months-filter-closed-sales-specialist",
          getColumns(),
          office_id
        );
        break;
  ...
  $(document).on('submit', '[id^="editSaleNoteForm"]', function (e) {
    ...
    switch (datatableName) {
        case 'close_sale_nurse_sample':
            ajaxUrl = '/last-6months-closed-sales-nurse-ajax'; // Define your actual route here
            break;
        case 'close_sale_nonnurse_sample':
            ajaxUrl = '/last-6months-closed-sales-nonnurse-ajax'; // Define your actual route here
            break;
        case 'close_sale_specialist_sample':
            ajaxUrl = '/last-6months-closed-sales-specialist-ajax'; // Define your actual route here
            break;
        default:
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            switch (datatableName) {
                case 'close_sale_nurse_sample':
                    close_sales_tab("close_sale_nurse_sample", "last-6months-closed-sales-nurse-ajax", columns);
                    break;
                case 'close_sale_nonnurse_sample':
                    close_sales_tab("close_sale_nonnurse_sample", "last-6months-closed-sales-nonnurse-ajax", columns);
                    break;
                case 'close_sale_specialist_sample':
                    close_sales_tab("close_sale_specialist_sample", "last-6months-closed-sales-specialist-ajax", columns);
                    break;
                default:
