...
<div class="content-wrapper ml-0">
	<div class="card-header header-elements-inline justify-content-end">
		@can('applicant_open_to_paid')
		 <a href="{{ route('crm.export_email',['not_attended'])}}" class="btn bg-slate-800 legitRipple">
    ...
    <!-- Content area -->
     <!-- <div class="content"> -->
        <table class="table table-hover table-striped" id="crm_not_attended_cv_sample">
            <thead>
            <tr>
                <th>Date</th>
                <th>Time</th>
