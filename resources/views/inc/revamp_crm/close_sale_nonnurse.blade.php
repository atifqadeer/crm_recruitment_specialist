...
<button id="clear_filter_close_nonnurse_btn" title="Refresh" class="btn btn-outline alpha-teal text-teal-400 border-teal-400 border-2 float-right ml-1"><i
        ...
        <div class="col-4">
			@can('sale_export_email')
             <a href="{{ route('sales.export_email',['job_category'=>'nonnurse','duration' => 'all'])}}" class="btn bg-slate-800 legitRipple float-right" style="margin-right:20px;">
    ...
    <!-- Content area -->
    <div class="content">
        <table class="table table-hover table-striped" id="close_sale_nonnurse_sample">
            <thead>
            <tr>
                <th>Created Date</th>
                <th>Updated Date</th>
