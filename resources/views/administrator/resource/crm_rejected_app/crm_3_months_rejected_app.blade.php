      ...
      $(document).ready(function() {
        ...
        console.log('id is :'+ id);
          $('#all_reject_applicant_sample').DataTable({
               ...
               "serverSide": true,
               "order": [],
               "ajax":"/get-rejected-app-date-wise-ajax/"+id+"/"+month,
               "columns": [
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">CRM {{$range_val}} Rejected - {{$id == 44? 'Nurse':'Non Nurse'}} Applicants </span>
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Crm {{$range_val}} Rejected {{$id == 44? 'Nurse':'Non Nurse'}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <input type="hidden" name="category" id="category" value="{{$id}}" />
                ...
                <table class="table table-hover table-striped" id="all_reject_applicant_sample">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
