      ...
      $(document).ready(function() {
        $.fn.dataTable.ext.errMode = 'none';
          ...
          $('#applicant_sample_1').DataTable({
               ...
               "serverSide": true,
               "responsive": true,
               "ajax":"get_no_responsed_applicants_ajax",
               "order": [],
               "columns": columns
          });
          ...
          $('#submitSelectedButton').on('click', function() {
              ...
              // Submit AJAX request
              $.ajax({
                  url: '/no-responed-revert-all', // Update the URL to match your route
                  type: 'POST',
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Resources</span> - No Responded Applicants
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">No Responded Applicants</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">No Responded Applicants</h5>
                    @if(Auth::id()== 101)
