...
@section('style')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#not_attended_applicant_sample').DataTable({
                "processing": true,
                "serverSide": true,
                "order": [],
                "ajax":"getCrmNotAttendedApplicantsCvAjax",
                "columns": [
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Applicants</span> - Not Attended
                    </h5>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Not Attended Applicants
                    </h5>
                </div>
				<div class="card-body">
                    ...
                    <a href="{{ route('export_crm_not_attended_applicants_cv') }}" class="btn bg-slate-800 legitRipple float-right" style="margin-right:20px;">
                ...
                <table class="table table-hover table-striped" id="not_attended_applicant_sample">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
