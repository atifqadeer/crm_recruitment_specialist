            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Applicant Temporary Not Interested</span> -
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">@if($interval == 7)Last 7 Days @elseif($interval == 21) Last 21 Days @elseif($interval == 60) Not Interested @endif</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Temporarily Not Interested Applicants -
                        @if($interval == 7)
                            Last 7 Days - Nurses
                        @elseif($interval == 21)
                            Last 21 Days
...
//     var crm_table = '';
// var table = 'last_2_months_blocked_sample';
