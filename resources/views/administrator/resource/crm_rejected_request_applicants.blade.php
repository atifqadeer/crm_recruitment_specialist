    ...
    <script>
      ...
      $(document).ready(function() {
        $.fn.dataTable.ext.errMode = 'none';
          $('#reject_request_applicant_sample').DataTable({
              "processing": true,
              "serverSide": true,
              "ajax":"getCrmRequestRejectedApplicantsCvAjax",
              "order": [],
              "columns": [
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Applicants</span> - Request Rejected
                    </h5>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Request Rejected Applicants
                    </h5>
                </div>
				<div class="card-body">
                    ...
                    <a href="{{ route('export_crm_request_rejected_applicants_cv') }}" class="btn bg-slate-800 legitRipple float-right" style="margin-right:20px;">
                ...
                <table class="table table-hover table-striped" id="reject_request_applicant_sample">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
