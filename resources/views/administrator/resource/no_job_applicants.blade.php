...
@section('style')
    ...
    <script>
        var columns = [
			...
			{ "data":"applicant_job_title", "name": "applicant_job_title", "orderable": false, render: function(data) { return data.toUpperCase(); } },
            { "data": "job_category", "name": "job_category", render: function(data) { return data.toUpperCase(); } },
