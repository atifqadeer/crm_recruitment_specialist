...
@section('style')
    ...
    <script>
        var columns = [
			...
			{ "data":"status", "name": "applicants.status", "orderable": false }
		];
    ...
    $(document).ready(function() {
        ...
        var allApplicants = $('#all_resources_table').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{!! url('getlast21DaysApp') !!}/" + app_id,
            "order": [[0, 'desc']],
            "columns": columns
        });
        ...
        var notInterested = $('#not_interested_resources_table').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{!! url('getlast21DaysAppNotInterested') !!}/" + app_id,
            "order": [[0, 'desc']],
            "columns": columns,
        ...
        var blockedApplicants = $('#blocked_resources_table').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{!! url('getlast21DaysAppBlocked') !!}/" + app_id,
            "order": [[1, 'desc']],
