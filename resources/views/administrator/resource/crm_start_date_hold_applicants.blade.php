...
@section('style')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#start_date_hold_applicant_sample').DataTable({
                "processing": true,
                "language": {
                ...
                "serverSide": true,
                "order": [],
                "ajax":"getCrmStartDateHoldApplicantsCvAjax",
                "columns": [
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Applicants</span> - Start Date Hold
                    </h5>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Start Date Hold Applicants
                    </h5>
                </div>
				<div class="card-body">
                    ...
                    <a href="{{ route('export_crm_start_date_hold_applicants_cv') }}" class="btn bg-slate-800 legitRipple float-right" style="margin-right:20px;">
                ...
                <table class="table table-hover table-striped" id="start_date_hold_applicant_sample">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
