				...
				if (targetTab === "#all_nurse_resources") {
					...
					if (!allApplicants) {
						allApplicants = $('#all_nurse_resources_table').DataTable({
							"processing": true,
							"serverSide": true,
							"ajax": "{!! url('getlast12MonthsApplicationAjax') !!}/" + job,
							"order": [[0, 'desc']],
							"columns": columns
						});
					} else {
					...
					if (!notInterested) {
						notInterested = $('#not_interested_nurse_resources_table').DataTable({
							"processing": true,
							"serverSide": true,
							"ajax": "{!! url('getlast12MonthsNotInterestedApplicationAjax') !!}/" + job,
							"order": [[0, 'desc']],
							"columns": columns
						});
					} else {
					...
					if (!blockedApplicants) {
						blockedApplicants = $('#blocked_nurse_resources_table').DataTable({
							"processing": true,
							"serverSide": true,
							"ajax": "{!! url('getlast12MonthsBlockedApplicationAjax') !!}/" + job,
							"order": [[0, 'desc']],
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                   ...
                   <h5>
                        ...
                        <span class="font-weight-semibold">Resources </span> - {{ $jobType }} Applicants ( Last 12 Months )
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Last 12 Months</span>
                    </div>
                </div>
