            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Sales</span> - Closed Sales - Last 12 Months Closed Sales
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Last 12 Months Closed Sales</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-tabs-highlight">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane active" id="close_sale_nurse">
                            @include('inc/revamp_crm/closed_sales/last_12months_close_sale_nurse')
                        </div>
                        <div class="tab-pane" id="close_sale_nonnurse">
                            @include('inc/revamp_crm/closed_sales/last_12months_close_sale_nonnurse')
                        </div>
                        <div class="tab-pane" id="close_sale_specialist">
                            @include('inc/revamp_crm/closed_sales/last_12months_close_sale_specialist')
                        </div>
                    </div>
                </div>
            </div>
...
@section('js_file')
    ...
    <script src="{{ asset('js/last_12months_close_sale.js') }}?v={{ time() }}"></script>
@endsection