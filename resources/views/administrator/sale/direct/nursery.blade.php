...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#sale_sample_1').DataTable({
            ...
            "sAjaxSource": "{{ url('getDirectActiveSalesAjax') }}/nursery",
            "aLengthMenu": [
                [10, 50, 100, 500],
                [10, 50, 100, 500]
            ],
        ...
        $('#filter').on('click', function () {
            ...
            table.ajax.url("{{ url('getDirectActiveSalesAjax') }}/nursery?start_date=" + start_date + "&end_date=" + end_date).load();
        });
    });
</script>
        ...
        <div class="page-header-content header-elements-inline">
            <div class="page-title">
                <h5>
                    ...
                    <span class="font-weight-semibold">Sales</span> - Direct Sales - Nursery
                </h5>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Nursery</span>
                </div>
            </div>
        </div>
    </div>
