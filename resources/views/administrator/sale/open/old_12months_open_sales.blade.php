...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#sale_sample_1').DataTable({
            ...
            "sAjaxSource": "{{ url('getOld12monthsOpenSalesAjax') }}",
            "aLengthMenu": [
                [10, 50, 100, 500],
                [10, 50, 100, 500]
            ],
...
<div class="content-wrapper">
        ...
        <div class="page-header-content header-elements-inline">
            <div class="page-title">
                <h5>
                    ...
                    <span class="font-weight-semibold">Sales</span> - Open Sales - 12 Months Old Open Sales
                </h5>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="#" class="breadcrumb-item">Open Sales</a>
                    <a href="#" class="breadcrumb-item">Current</a>
                    <span class="breadcrumb-item active">12 Months Old Open Sales</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="card">
                    ...
                    <div class="col-md-12" style="padding-right: 0 !important;">
                        <form class="form-inline" name="sale_filter_form" id="sale_filter_form">
                            ...
                            <div class="col-md-2 d-flex" style="padding-right: 0 !important;">
                                <button type="submit"
                                    class="btn btn-outline bg-teal-400 text-teal-400 border-teal-400 border-2 flex-grow-1 mr-2 search"><i
                                        class="fa fa-search"></i> Search</button>
                                <button id="refresh_filters"
                                    class="btn btn-outline alpha-teal text-teal-400 border-teal-400 border-2 float-right"><i
            ...
            <div class="card-body row pb-0">
                ...
                <div class="col-md-6">
                    @can('sale_export_email')
                    <a href="{{ route('sales.export_open_sales_email',['duration' => '12_months_old'])}}" class="btn bg-slate-800 legitRipple float-right">
                   ...
                   @endcan
                    @can('sale_import')
                        ...
                        data-target="#import_sale_csv" class="btn mr-2 bg-slate-800 legitRipple float-right">
                        <i class="icon-cloud-upload"></i>
                        &nbsp;Import</a>
                    @endcan
                    @can('sale_create')
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('saleCsv') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf()
                                    <div class="form-group">
                                        <label for="headOffice"> Head Office</label>
                                        <select name="head_office" id="head_office_id"
    ...
    <script>
        ...
        $(document).on('click', '.search', function (event) {
            ...
            table.ajax.url('getOld12monthsOpenSalesAjax?' + form_data).load();
        });
        ...
        $(document).on('click', '#refresh_filters', function (event) {
            ...
            table.ajax.url('getOld12monthsOpenSalesAjax').load();
        });
        ...
        $("#job_category_filter").change(function () {
            ...
            if (job == "nurse") {
                var options = "";
                options +=
                    "<label>Select Job Profession</label><select name='job_specialist' class='form-control form-control-select2' id='job_specialist_filter' required><option value=''>Select Specialist</option>";
                ...
                var options = "";
                options +=
                    "<label>Job Specialist Title</label><select name='job_specialist' class='form-control form-control-select2' id='job_specialist_filter' required><option value=''>Select Specialist</option>";
                options += "<option value='nurse specialist'>Nurse Specialist</option>";
                options += "<option value='nonnurse specialist'>Non Nurse Specialist</option>";
                options += "</select>";
                $("#job_specialist_filter").html(options);
