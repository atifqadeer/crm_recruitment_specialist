...
@section('style')
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#sale_filter_office").select2({ width: '100%' });
            ...
            <div class="page-header-content header-elements-inline">
                <div class="page-title">
                    <h5>
                        ...
                        <span class="font-weight-semibold">Sales</span> - Open Sales - All Open Sales
                    </h5>
                </div>
            </div>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">All Open Sales</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body row pb-0">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{ route('sales.export_open_sales_email',['duration' => 'all'])}}" class="btn bg-slate-800 legitRipple float-right">
                           <i class="icon-cloud-upload"></i>
                           &nbsp;Export Email</a>
						<a href="{{ route('exportSalesWithNoLatLng')}}" class="btn bg-slate-800 mr-2 legitRipple float-right">
                       <i class="icon-cloud-upload"></i>
                       &nbsp;Export With No LAT & LONG</a>
                       @endcan
                        @can('sale_import')
                            <a href="#"
