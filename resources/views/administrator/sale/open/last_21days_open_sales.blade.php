...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#sale_sample_1').DataTable({
            ...
            "sAjaxSource": "{{ url('getLast21daysOpenSalesAjax') }}",
            "aLengthMenu": [
                [10, 50, 100, 500],
                [10, 50, 100, 500]
            ],
...
<div class="content-wrapper">
        ...
        <div class="page-header-content header-elements-inline">
            <div class="page-title">
                <h5>
                    ...
                    <span class="font-weight-semibold">Sales</span> - Open Sales - Last 21 Days Open Sales
                </h5>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Last 21 Days Open Sales</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body row pb-0">
                ...
                <div class="col-md-6">
                    ...
                    <a href="{{ route('sales.export_open_sales_email',['duration' => 'last_21_days'])}}" class="btn bg-slate-800 legitRipple float-right">
    ...
    <script>
        ...
        $(document).on('click', '.search', function (event) {
            ...
            table.ajax.url('getLast21daysOpenSalesAjax?' + form_data).load();
        });
        ...
        $(document).on('click', '#refresh_filters', function (event) {
            ...
            table.ajax.url('getLast21daysOpenSalesAjax').load();
        });
