            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">CVs Cleared</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Applicants Confirmed For Interviews, With Their CVs</h5>
                </div>

                <div class="card-body">
                </div>

                <table class="table table-hover table-striped" id="quality_cleared_sample_1">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>Time</th>
